...
namespace BasketAPI.Repositories
{
    ...
    {
        private static IList<ShoppingCart> _shoppingCarts=new List<ShoppingCart> { new ShoppingCart { UserName = "TD", Items = new List<ShoppingCartItem> { new ShoppingCartItem { Color = "Red", Price = 150000, ProductId = "GalaxySamsung", Name = "GalaxySamsung", Quantity = 2 } } } };
